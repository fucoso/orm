...
class ModelTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testNewPerson()
    {
        ...
        $p2 = Person::get($id);
        $this->assertInstanceOf("Fucoso\ORM\Tests\\Models\\Person", $p2);
        $this->assertEquals($p, $p2);

        // Alternative get
        $p3 = Person::get(array($id));
        $this->assertInstanceOf("Fucoso\ORM\Tests\\Models\\Person", $p3);
    ...
    public function testNewTrade()
    {
        ...
        $this->assertInstanceOf("Fucoso\ORM\Tests\\Models\\Trade", $t2);
        $this->assertEquals($t, $t2);

        // Alternative get
        $t3 = Trade::get(array($date, $no));
        $this->assertInstanceOf("Fucoso\ORM\Tests\\Models\\Trade", $t3);
    ...
    /**
     * @expectedException \Exception
     * @expectedExceptionMessage Property [xxx] does not exist in class [Fucoso\ORM\Tests\Models\Person]
     */
     ...
     *
     * @expectedException \Exception
     * @expectedExceptionMessage  Primary key not defined for model [Fucoso\ORM\Tests\Models\PkLess].
     */
    ...
    /**
     * @expectedException \Exception
     * @expectedExceptionMessage Model [Fucoso\ORM\Tests\Models\Person] has 1 primary key columns. 3 arguments given.
     */
    ...
    /**
     * @expectedException \Exception
     * @expectedExceptionMessage [Fucoso\ORM\Tests\Models\Person] record with primary key [12345678] does not exist.
     */
    ...
    public function testDump()
    {
        ...
        $expected = implode("\n", array(
            'Fucoso\ORM\Tests\Models\Person (testdb.person)',
            '==============================================',
            'id: 10 (PK)',
            'name: "Tom Lehrer"',
            'email: "tom@lehrer.net"',
